  ...
  return (
      ...
      <div className="relative  sm:mt-6">
                    <input
                      ...
                      required
                      type="text"
                      className="peer  font-bold text-brand-culturedDark placeholder-transparent flex-grow w-full border-b border-brand-text focus:outline-none bg-brand-gunmetal h-12  mb-2  focus:border-brand-culturedDark "
                      id={forText}
                      name={forText}
                    />
                    <label
